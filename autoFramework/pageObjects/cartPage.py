from pageObjects.locators.CartPageLocators import CartPageLocators
...
class CartPage(CartPageLocators):
    ...
    def get_all_product_names_in_cart(self):
        products_name_elements = self.sl.wait_and_get_elements(self.PRODUCT_NAMES_IN_CART)
        product_names = [i.text for i in products_name_elements]
